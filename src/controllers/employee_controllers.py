...
class EmployeeControllers:
    ...
    def display_employee_details(self, user_id: str) -> list:
        """Method that displays data for employee"""

        data = db.fetch_data(Queries.FETCH_DETAILS_BY_UID, (user_id,))
        return data

    def display_assets_assigned(self, user_id: str) -> list:
        """Method that displays asset assigned"""
        data = db.fetch_data(Queries.FETCH_ASSIGNED_ASSETS_BY_UID, (user_id,))
        return data

    def raise_issue(self, user_id: str, asset_id: str) -> bool:
        """Method that raises issue in the database"""
