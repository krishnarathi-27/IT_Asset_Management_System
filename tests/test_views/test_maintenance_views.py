...
class TestMaintenanceViews(TestCase):
    ...
    def test_maintenance_operations_positive(self, mock_maintenance_menu) -> bool:
        ...
        self.assertIsNone(self.maintenance_views_obj.maintenance_operations())
    ...
    def test_maintenance_menu_negative(self, mock_input, mock_case_1, mock_case_2, mock_case_3) -> bool:
