...
class TestAssetDataController(TestCase):
    ...
    def test_check_category_with_vendor_positive(self,mock_db):
        ...
        self.assertTrue(self.asset_data_obj.check_category_with_vendor("MPN45rd","CATdf3e","VEN4fdd"))
    ...
    def test_check_category_with_vendor_negative(self,mock_db):
        ...
        self.assertFalse(self.asset_data_obj.check_category_with_vendor("MPN45rd","CATdf3e","VEN4fdd"))
        mock_db.fetch_data.assert_called_once()
    ...
    @mock.patch('src.controllers.asset_data_controllers.AssetDataControllers.check_category_with_vendor')
    @mock.patch('src.controllers.asset_data_controllers.db')
    ...
    @mock.patch('src.controllers.asset_data_controllers.AssetDataControllers.check_category')
    @mock.patch('src.controllers.asset_data_controllers.db')
